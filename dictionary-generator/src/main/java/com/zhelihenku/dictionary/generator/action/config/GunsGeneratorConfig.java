package com.zhelihenku.dictionary.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        ...
        globalConfig.setAuthor("PhilWang");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.zhelihenku.dictionary.admin.common.persistence.model");
        packageConfig.setMapper("com.zhelihenku.dictionary.admin.common.persistence.dao");
        packageConfig.setXml("com.zhelihenku.dictionary.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.zhelihenku.dictionary.admin");
        contextConfig.setCoreBasePackage("com.zhelihenku.dictionary");
