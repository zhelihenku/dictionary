...
6. controller层采用map + warpper方式的返回结果，返回给前端更为灵活的数据，具体参见com.zhelihenku.dictionary.modular.system.warpper包中具体类。
...
9. 控制器层统一的异常拦截机制,利用@ControllerAdvice统一对异常拦截,具体见com.zhelihenku.dictionary.aop.GlobalExceptionHandler类。
...
```
@Configuration
@MapperScan(basePackages = {"com.zhelihenku.dictionary.modular.*.dao", "com.zhelihenku.dictionary.common.persistence.dao"})
