package com.zhelihenku.dictionary.modular.code.factory;


import com.zhelihenku.dictionary.DictionaryApplication;
import com.zhelihenku.dictionary.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("PhilWang");
        genQo.setProjectPackage(DictionaryApplication.class.getPackage().getName());
